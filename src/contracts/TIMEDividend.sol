...
contract TIMEDividend is Ownable, ERC20, ERC20Burnable, Utils, Multicall {
    ...
    */
    ...
    /** 
    * @dev This internal function is overriden from {ERC20} contract to handle mag corrections
    * See {ERC20-_beforeTokenTransfer} for more details
    * @notice updates magified dividend corrections as they are transfered between accounts
    * @param from the address to send the tokens to
    * @param to the address to send tokens to
    * @param amount the count of tokensbeing sent
    ...
    * @return Total clamable dividend of `account`
    */
